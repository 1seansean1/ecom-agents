---
name: audit
description: "Run the Holly Grace cross-document consistency audit (12 checks C001-C012). Reports PASS/FAIL/WARN for component counts, task counts, version refs, SIL counts, ruff, pytest, and Gantt freshness. Fixes any failures found. Use when: user says 'run audit', 'check consistency', 'validate documents', or invokes /audit."
---
